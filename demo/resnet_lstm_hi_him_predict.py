...
def main():
    ...
    config_file_path = ResnetLSTMVideoClassifier.get_config_file_path(model_dir_path,
                                                                     resnet_include_top=resnet_include_top)
    weight_file_path = ResnetLSTMVideoClassifier.get_weight_file_path(model_dir_path,
                                                                     resnet_include_top=resnet_include_top)
    ...
    predictor = ResnetLSTMVideoClassifier()
    ...
    plot_confusion_matrix(cm, Total_label,
                      title='Confusion matrix',normalize=True,file_path='Confusion_matrix_resnet.pdf')
